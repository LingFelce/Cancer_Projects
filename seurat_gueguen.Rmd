...
pathways <- as.character(reactome_enriched_pathways$Pathway)
...
write.csv(reactome_enriched, "/stopgap/donglab/ling/R/megat/gueguen_upregulated_reactome_105_enriched_pathways.csv")
```
